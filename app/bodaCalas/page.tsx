  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f5f3ef] text-[#1a1816]">
      <main className="relative z-10">
        ...
        <section className="relative flex min-h-screen flex-col items-center justify-center bg-[url('/bodaCalas/hero.jpg')] bg-cover bg-center bg-no-repeat px-5 pt-[60px] text-center md:pt-[0px]">
        ...
        {/* DETALLES */}
        <section id="detalles" className=" px-6 pb-20 text-center mt-20">
        ...
        {/* COUNTDOWN */}
        <section className="bg-[#101015] px-6 py-20 pt-10 md:pt-20 text-center text-[#f5f3ef] bg-[url('/bodaCalas/calabn.png')] bg-cover bg-center bg-no-repeat bg-position-[50%_70px]">
          ...
          <div className="md:bg-black/30 md:p-10 rounded-lg md:mx-auto">
