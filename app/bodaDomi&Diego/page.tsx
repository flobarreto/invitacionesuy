  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f5f3ef] text-[#1a1816]">
      ...
      <main className="relative z-10">
        ...
        <section
          id="detalles"
          className=" px-6 pb-20 text-center bg-[url('/bodaDomi&Diego/fondo.png')] bg-cover bg-center bg-no-repeat"
        >
          <div className="mx-auto max-w-[700px]">
          <div className="flex justify-center items-center w-[200px] h-[200px] mx-auto mb-[-50px]">
            <Image src="/bodaDomi&Diego/rings.png" alt="Rings" width={100} height={100} className="w-full h-auto" />
          </div>
          <h2
            className="mb-12 text-[clamp(2.5rem,7vw,4rem)] leading-none"
            style={{ fontFamily: "var(--font-bodoni, serif)" }}
          >
            Ceremonia
          </h2>
          ...
          <div className="mb-12 grid grid-cols-1 text-center md:grid-cols-2">
            <div className="p-6 md:border-r md:border-[#c8c0b4]">
              <span className="mb-3 block text-[0.65rem] uppercase tracking-[0.35em] text-black md:text-[0.8rem]">
                Fecha
              </span>
              <div
            ...
            <div className="mx-auto h-px w-[60px] bg-[#c8c0b4] md:hidden" />
            ...
            <div className="p-6 md:col-span-2">
              ...
              <a
                ...
                className="mt-1 block text-[0.85rem] text-[#4a4540] underline underline-offset-2 transition hover:text-[#1a1816] hover:underline md:text-lg"
              >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a
              ...
              target={openExternalInNewTab === true ? "_blank" : undefined}
              rel={
                openExternalInNewTab === true ? "noopener noreferrer" : undefined
              }
              className="inline-block border border-[#1a1816] bg-transparent px-9 py-3.5 text-[0.9rem] uppercase transition hover:bg-[#1a1816] hover:text-[#f5f3ef]"
            >
              Cómo ir?
            </a>
        ...
        {/* COUNTDOWN */}
        <section className="bg-[#1a1816] px-6 py-20 text-center text-[#f5f3ef] bg-[url('/bodaDomi&Diego/fondoDark.png')] bg-cover bg-center bg-no-repeat">
          <span className="mb-4 block text-[0.7rem] uppercase tracking-[0.4em] text-[#c8c0b4]">
            Faltan
          </span>
          ...
          <div className="flex flex-wrap justify-center gap-[clamp(16px,4vw,48px)]">
            <div className="flex flex-col items-center">
              <span
                className="text-[clamp(3rem,10vw,6rem)] md:text-[clamp(1.5rem,5vw,3rem)] font-bold leading-none"
                style={{ fontFamily: "var(--font-bodoni, serif)" }}
              >
                {timeLeft.days}
              </span>
              <span className="mt-2 text-[0.65rem] uppercase tracking-[0.35em] text-[#c8c0b4]">
                Días
              </span>
            </div>

            <span
              className="self-start pt-0.5 text-[clamp(3rem,10vw,6rem)] md:text-[clamp(1.5rem,5vw,3rem)] leading-none"
              style={{ fontFamily: "var(--font-bodoni, serif)" }}
            >
              :
            </span>
        ...
        <div className="mx-auto mt-[50px] flex h-[100px] w-[100px] items-center justify-center md:h-[200px] md:w-[200px]">
          <Image
            src="/bodaDomi&Diego/gift.png"
            alt="Gift"
            width={200}
            height={200}
          ...
          <div className=" px-5 pb-7 sm:px-10 sm:py-10">
            ...
            <div className="text-[0.7rem] uppercase tracking-[0.3em] text-white md:text-[0.85rem]">
            ...
            <div className="mt-5 flex flex-col items-center gap-2">
              <div className="flex items-center justify-center gap-3">
                <div
                  className="text-[clamp(1.4rem,4vw,2rem)] tracking-[0.08em] text-white md:text-[clamp(1.85rem,3vw,2.5rem)]"
                  style={{ fontFamily: "var(--font-bodoni, serif)" }}
                >
                  {accountNumber}
                </div>
                <button
                  ...
                  className="inline-flex shrink-0 text-white transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1a1816]"
                >
                  <Copy
              ...
              <p className="mb-2 mt-[-10px] min-h-[1.25rem] text-sm text-white md:min-h-[1.5rem] md:text-base">
                {accountCopied ? "✓ Copiado" : ""}
              </p>
            </div>

            <div className="mb-5">
              <div className="mb-1 text-[0.7rem] uppercase tracking-[0.3em] text-white md:text-[0.85rem]">
                Titular
              </div>
        ...
        <section
          id="asistencia"
          className=" px-6 py-20 text-center bg-[url('/bodaDomi&Diego/fondo.png')] bg-cover bg-center bg-no-repeat"
        >
          <div className="mx-auto max-w-[700px]">
          <h2
            className="mb-4 text-[clamp(2.5rem,7vw,4rem)] leading-none"
            style={{ fontFamily: "var(--font-bodoni, serif)" }}
          >
          ...
          <div className=" px-5 text-left sm:px-10 sm:py-12">
            <form onSubmit={handleRsvpSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-[0.7rem] font-bold uppercase text-[#4a4540]">
                  Confirmar asistencia
                </p>
                <div className="flex flex-col gap-3 text-[#1a1816]">
                  {[
                    ...
                    >
                      <input
                        ...
                        className="h-4 w-4 accent-[#1a1816]"
                      />
                      {option.label}
                    </label>
                  ))}
              ...
              <div className="flex flex-col gap-3">
                ...
                {[
                  ...
                  return (
                    <label
                      key={option.value}
                      className="flex items-center gap-3 text-[#1a1816]"
                    >
                      <input
                        type="checkbox"
                        value={option.value}
                        ...
                        className="h-4 w-4 rounded accent-[#1a1816]"
                      />
                      {option.label}
                    </label>
                  );
        ...
        <div className="mx-auto mb-[-109px] md:mb-[-139px] flex h-[100px] w-[100px] items-center justify-center md:h-[200px] md:w-[200px]">
          <Image
            src="/bodaDomi&Diego/perro.png"
            alt="Perro"
            width={200}
            height={200}
            className="h-auto w-full"
        ...
        <footer className="bg-[#1a1816] text-white py-5 md:py-10 px-6">
        <div className="bg-[#1a1816] px-6 py-12 text-center text-[#f5f3ef]">
          <div
          ...
          <p className="text-[0.75rem] uppercase tracking-[0.3em] text-[#c8c0b4]">
            30 · 05 · 2026 <br />
            Montevideo, Uruguay
          </p>
        </div>
