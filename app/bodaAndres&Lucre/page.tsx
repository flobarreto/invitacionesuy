...
export default function BodaAndresLucre() {
  ...
  return (
    <main className="min-h-screen w-full min-w-0 max-w-full overflow-x-clip bg-[#fffaf4] font-cormorant-garamond">
      ...
      {/* <section
        className="px-6 md:py-20 md:px-12 md:py-28 bg-[#fffaf4] md:h-[800px] h-[500px] flex items-start md:items-center justify-center bg-[url('/fotosAndres&Lucre/themMobile.png')] md:bg-[url('/fotosAndres&Lucre/them.png')]"
        style={{
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
      ...
      >
        <div className="md:hidden w-[50%] ml-auto text-right text-xl text-[#fffaf4]">
        ...
        <div className="hidden md:block mx-auto text-center text-2xl mt-[-60px] ">
          A disfrutar este momento
          <br /> especial con nosotros
